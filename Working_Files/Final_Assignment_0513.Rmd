...
Chatt_clusters <- Chatt_census %>% 
  ...
  mutate(cluster_name = case_when(
    cluster_id == "1" ~ "Transitional Gentrification Zone",
    cluster_id == "2" ~ "Rapidly Gentrifying",
    cluster_id == "3" ~ "Established Affluent",
    cluster_id == "4" ~ "Emerging Gentrification Trends",
    TRUE ~ "Other"
  )) %>%
  select(cluster_name, cluster_id, everything())
